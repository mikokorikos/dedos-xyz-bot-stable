...
export const buildMessagesPrefixGuildOnlyEmbed = (): ReturnType<typeof embedFactory.error> =>
  embedFactory.error({
    title: 'Accion no disponible',
    description: 'Este comando solo se puede utilizar dentro de un servidor.',
  });

export const buildMessagesSlashGuildOnlyEmbed = (): ReturnType<typeof embedFactory.error> =>
  embedFactory.error({
    title: 'Accion no disponible',
    description: 'Este comando solo puede utilizarse dentro de un servidor de Discord.',
  });

export const buildMessagesUnexpectedErrorEmbed = (): ReturnType<typeof embedFactory.error> =>
  embedFactory.error({
