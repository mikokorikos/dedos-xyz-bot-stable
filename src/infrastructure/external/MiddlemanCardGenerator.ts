  ...
  public async renderProfileCard(options: ProfileCardOptions): Promise<AttachmentBuilder | null> {
    ...
    try {
      ...
      if (options.discordAvatarUrl) {
        ...
        if (discordAvatar) {
          rendererLog.info('renderProfileCard', 'discord-avatar:loaded', {
            discordTagHash: hashedTag,
        ...
        rendererLog.info('renderProfileCard', 'discord-avatar:missing-url', {
          discordTagHash: hashedTag,
        });
      }
      ...
      if (robloxUserId) {
        ...
        if (robloxAvatar) {
          rendererLog.info('renderProfileCard', 'roblox-avatar:loaded', {
            robloxUserHash,
            cacheKey: robloxCacheKey,
        ...
        rendererLog.info('renderProfileCard', 'roblox-avatar:missing-user', {});
      }
